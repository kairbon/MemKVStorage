package org.example.memstorge.utils;
...
public class ByteUtils {
  ...
  private final static ByteArrayComparator comparator = new LexicographicByteArrayComparator();

  public static final byte[] EMPTY_BYTES = new byte[0];

  public static ByteArrayComparator getComparator() {
    return comparator;
  }
